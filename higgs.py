...
def ams_score(y_true,y_pred,**kwargs):
	...
	print 'AMS = %6.3f [AMS_max = %6.3f] %-32s  ---  ratio(pred): %6.4f ratio(truth): %6.4f wfactor=%8.2f'%(ams,ams_max,info,wsum/(float(y_pred.shape[0])),wsum_truth/(float(y_pred.shape[0])),wfactor)
