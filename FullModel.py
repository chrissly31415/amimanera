...
class XModel:
   ...
   def __init__(self, name,classifier,Xtrain,Xtest,ytrain=None,sample_weight=None,cutoff=None,class_names=None,cv_labels=None,bag_mode=False):
      self.name = name
...
class ConstrainedLinearRegressor(BaseEstimator):
    ...
    def __init__(self,lowerbound=0,upperbound=1.0, n_classes=1, alpha=None, corr_penalty=None, normalize=False,loss='rmse',greater_is_better=False):
